...
import calcExpression, * as myModule from './calculator/index.js';
import fetchUser from './profile/gateway.js';
import { printProfile } from './profile/index.js';
import './polyfills/array-flat.js' //import for polyfills
import './polyfills/array-flatMap.js'

const calcResult = calcExpression('1 + 2');
const sumResult = myModule.sum(1, 2);
const multResult = myModule.mult(1, 2);
